<template>
	...
	<view class="page">
		<view v-if="btnshow0" style="font-size: 28px; font-weight: 400;margin-top: 1vh;">发布合作岗位</view>
		<view v-if="btnshow1" style="font-size: 28px; font-weight: 400;margin-top: 1vh;">修改合作岗位</view>
		...
		<view>
			...
			<view style="display: flex; flex-direction: row;align-items: center; margin: 2vh 0;">
				<view style="display: flex; flex-direction: row; align-items: center; margin: 2vh 0;">
					<input  v-model="data.name" placeholder="请输入招聘标题"/>
				</view>
		...
		<view>
			...
			<view style="display: flex; flex-direction: row;align-items: center; margin: 2vh 0;">
				<view style="display: flex; flex-direction: row; align-items: center; margin: 2vh 0;">
					<input type="number" v-model="data.number" placeholder="请输入招聘人数"/>
				</view>
				<uni-icons type="right" size="16" color="grey" style=" position: absolute; right: 5%; "></uni-icons>
			</view>
		</view>
		...
		<view style="margin-bottom: 14vh;">
			...
			<view style="display: flex; flex-direction: row;align-items: center; margin: 2vh 0;">
				<textarea type="number" v-model="data.notes" placeholder="请详细描述岗位"/>
			</view>
		</view>
